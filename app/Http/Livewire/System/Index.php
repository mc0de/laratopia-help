...
class Index extends Component
{
    ...
    public function mount()
    {
        ...
        $this->orderable         = (new System())->orderable;
    }

    public function render()
    {
        $query = System::with(['team'])->advancedFilter([
            's'               => $this->search ?: null,
        ...
        return view('livewire.system.index', compact('query', 'systems'));
    }
    ...
    public function deleteSelected()
    {
        ...
        System::whereIn('id', $this->selected)->delete();
